 ...
 */
var krossProduct = function krossProduct(a, b) {
 ...
 * Otherwise, null.
 */
var getIntersection = function getIntersection(a1, a2, b1, b2) {
  ...
  var vb = { x: b2.x - b1.x, y: b2.y - b1.y };
  // We also define a function to convert back to regular point form:

  /* eslint-disable arrow-body-style */

  var toPoint = function toPoint(p, s, d) {
    return {
      x: p.x + s * d.x,
      y: p.y + s * d.y
    };
