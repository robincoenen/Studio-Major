...
While elaborated calligraphy surely is a key achievement of the islamic civilization, _writing_ itself is definitly one of the most important key achievements of the humandkind. And it is an interesting and broad chimera of different elements, such as technology, art, code, cultural identity and more.  
...
The visualisation could be organised in a "textblock", readable from left to right. Furthermore it could use _text_ itself as an dataelement. 
